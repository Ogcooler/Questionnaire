                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="name" value="{{ old('name') }}" placeholder="Имя" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="password" class="pass-label">Пароль</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="passconf-label">Подтвердите пароль</label>
